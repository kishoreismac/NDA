...
export const ROLES = [
  {
    ...
    users: [
      { id: "sara",   name: "Sara Patel",   title: "Business Lead" },
      { id: "maya",   name: "Maya Davis",   title: "Procurement Manager" },
      { id: "riley",  name: "Riley Gomez",  title: "Sales Director" },
    ],
  },
  {
    id: "legal",
    ...
    users: [
      { id: "alex",     name: "Alex Kim",       title: "Senior Counsel" },
      { id: "jordan",   name: "Jordan Nguyen",  title: "Privacy Counsel" },
      { id: "elena",    name: "Elena Park",     title: "Contracts Lead" },
    ],
  },
  {
    id: "admin",
    ...
    users: [
      { id: "admin1", name: "Diego Rivera",   title: "Legal Ops Admin" },
      { id: "admin2", name: "Hannah Chen",    title: "System Administrator" },
    ],
  },
  {
    id: "exec",
    ...
    users: [
      { id: "ceo",  name: "Priya Mehta",  title: "Chief Executive Officer" },
      { id: "clo",  name: "Marcus Wells", title: "Chief Legal Officer" },
    ],
  },
];
