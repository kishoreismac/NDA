...
export const adminUsers = [
  { name: "Sara Patel", role: "Legal Ops Lead", email: "sara.patel@contoso.com" },
  { name: "Jordan Nguyen", role: "Senior Counsel", email: "j.nguyen@contoso.com" },
  { name: "Maya Davis", role: "Paralegal", email: "m.davis@contoso.com" },
  { name: "Aaron Kim", role: "Chief Legal Officer", email: "a.kim@contoso.com" },
  { name: "Elena Park", role: "Privacy Officer", email: "e.park@contoso.com" },
];
