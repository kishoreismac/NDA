...
describe("agreement and expiry date calculations", () => {
  it("calculates end date from start date and preset term", () => {
    ...
    expect(computeEndDate("2026-01-01", "five (5) years")).toBe("2030-12-31");
  });
  ...
  it("calculates exact human-readable duration from start and end dates", () => {
    ...
    expect(formatCustomTerm("2026-01-15", "2026-02-16")).toBe("1 month 1 day");
    expect(formatCustomTerm("2026-01-15", "2026-01-16")).toBe("1 day");
  ...
  it("maps exact date gaps back to preset terms", () => {
    ...
    expect(computeTermFromDates("2026-01-01", "2030-12-31")).toBe("five (5) years");
    expect(matchesPreset("2026-01-01", "2028-01-01")).toBe(true);
    expect(matchesPreset("2026-01-01", "2026-01-15")).toBe(false);
  });
